    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-10 h-18 flex items-center justify-between py-4">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link
            href="/product"
            className="flex items-center gap-2 px-5 py-2.5 text-sm font-600 bg-accent text-white rounded-lg hover:bg-accent-glow transition-all duration-200 hover:shadow-lg hover:shadow-accent/20 hover:-translate-y-0.5"
          >
            <Zap size={14} />
            Get Started
          </Link>
      ...
      <div className={`md:hidden transition-all duration-300 overflow-hidden ${open ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'}`}>
        <div className="glass-dark border-t border-border-subtle px-6 py-6 flex flex-col gap-5">
          ...
          <div className="pt-4 border-t border-border-subtle flex flex-col gap-3">
            ...
            <Link href="/product" onClick={() => setOpen(false)} className="w-full text-center py-3 text-sm font-600 bg-accent text-white rounded-lg hover:bg-accent-glow transition-all">
              Get Started
            </Link>
          </div>
        </div>
