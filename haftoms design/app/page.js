...
import { 
  ...
  Globe, Cpu, Network, TrendingDown, CheckCircle, 
  AlertTriangle, XCircle, Leaf, Scale, ChevronRight
} from 'lucide-react'
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0" style={{
        background: 'radial-gradient(ellipse at 20% 50%, rgba(0,212,255,0.07) 0%, transparent 60%), radial-gradient(ellipse at 80% 20%, rgba(124,58,237,0.07) 0%, transparent 60%)'
      }} />
      ...
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[600px] h-[600px] hidden xl:block opacity-30">
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          {/* Orbiting dots */}
          {[
            { color: '#00d4ff', delay: '0s', ring: 160 },
            { color: '#a855f7', delay: '3s', ring: 220 },
            { color: '#00d4ff', delay: '1.5s', ring: 280 },
          ].map((dot, i) => (
            <div
              key={i}
  ...
  const problems = [
    {
      ...
      desc: 'Centralized AI storage means sensitive organizational data lives on third-party servers — vulnerable to breaches, subpoenas, and unauthorized access.',
    },
    {
      icon: XCircle,
      color: 'text-red-400',
      ...
      desc: 'When you store vectors on cloud providers like Pinecone or Weaviate, you hand over control. They set the rules, access policies, and pricing.',
    },
    {
      icon: TrendingDown,
      color: 'text-yellow-400',
      bg: 'bg-yellow-500/10 border-yellow-500/20',
      title: 'Skyrocketing Storage Costs',
      desc: 'Vector databases are expensive at scale. Universities and enterprises pay millions annually for data that could live on existing infrastructure.',
    },
  ]
  ...
  return (
    <section className="relative py-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <SectionHeader
          badge="The Problem"
          title={<>The Broken State of <span className="gradient-text">AI Data Storage</span></>}
          subtitle="Organizations are feeding sensitive data into centralized systems they don't control — creating massive security, privacy, and cost risks."
        />
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-14">
          {problems.map(({ icon: Icon, color, bg, title, desc }) => (
            <div key={title} className={`glass border-glow rounded-2xl p-8 hover:-translate-y-1 transition-all duration-300`}>
              <div className={`inline-flex p-3 rounded-xl border ${bg} mb-6`}>
  ...
  const features = [
    {
      ...
      desc: 'Data is fragmented and spread across participating user devices within your organization — no central point of failure.',
    },
    {
      icon: Lock,
      title: 'Military-Grade Encryption',
      desc: 'Every data fragment is encrypted with AES-256 before leaving the server. Only your organization holds the keys.',
    },
    {
      icon: Database,
      title: 'Your Internal AI Cloud',
      desc: 'Willustore transforms idle storage on staff laptops and phones into a powerful, private vector database.',
    },
    {
      icon: Zap,
      title: 'Fast Retrieval',
      desc: 'HNSW indexing and gossip protocol ensure sub-millisecond vector search even across distributed nodes.',
    },
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-text-secondary text-lg leading-relaxed mb-8">
              Willustore creates a private, decentralized vector store from the unused storage on your organization's own devices. Data never leaves your ecosystem — encrypted fragments are distributed across trusted devices and retrieved on demand.
            </p>
          ...
          <div className="relative flex items-center justify-center">
            <div className="relative w-full max-w-md aspect-square">
              ...
              {[
                ...
                { label: '💻 Laptop', angle: 72, color: 'text-purple-400', bg: 'bg-purple-500/10' },
                ...
                return (
                  <div
                    key={label}
                    className={`absolute -translate-x-1/2 -translate-y-1/2 glass border ${bg} rounded-xl px-3 py-2 text-xs font-500 ${color} whitespace-nowrap`}
                    style={{
                      top: `calc(50% + ${y}px)`,
                      left: `calc(50% + ${x}px)`,
                    }}
  ...
  const steps = [
    {
      ...
      icon: Database,
      title: 'Store',
      desc: 'AI-generated vectors are encrypted and fragmented at the edge, then distributed to participating devices within your organization.',
    },
    {
      num: '02',
      icon: Network,
      title: 'Index',
      desc: 'A lightweight central HNSW index tracks where each fragment lives — without ever exposing the data itself.',
    },
    {
      num: '03',
      icon: Zap,
      title: 'Retrieve',
      desc: 'On query, fragments are fetched from nearby devices via WiFi or Bluetooth, decrypted, and assembled in milliseconds.',
    },
  ]
  ...
  return (
    <section className="relative py-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <SectionHeader
          badge="How It Works"
          title={<>Simple Process, <span className="gradient-text">Powerful Results</span></>}
          subtitle="Three steps to a fully distributed, encrypted AI vector store for your organization."
        />
          ...
          {steps.map(({ num, icon: Icon, title, desc }) => (
            <div key={num} className="relative text-center group">
              <div className="relative inline-flex flex-col items-center">
                <div className="w-16 h-16 rounded-2xl glass border border-accent/20 flex items-center justify-center mb-6 group-hover:glow-accent group-hover:border-accent/50 transition-all duration-300">
        ...
        <div className="mt-12 text-center">
          <Button href="/how-it-works" variant="secondary" size="md">
            Full Technical Overview <ChevronRight size={16} />
          </Button>
        </div>
      </div>
    </section>
...
function ValueProps() {
  const values = [
    {
      ...
      title: 'Up to 10× Cost Reduction',
      desc: 'Replace expensive managed vector DBs with your own distributed infrastructure.',
      metric: '90% savings',
    },
    {
      icon: Shield,
      ...
      title: 'Data Never Leaves Your Org',
      desc: 'Encrypted at rest and in transit. Only your devices, only your keys, only your control.',
      metric: 'Zero exposure',
    },
    {
      icon: Scale,
      color: 'text-purple-400',
      bg: 'bg-purple-500/10 border-purple-500/20',
      title: 'Scales With Your Users',
      desc: 'The more devices participate, the more storage you have — at no additional cost.',
      metric: 'Auto-scaling',
    },
    {
      icon: Leaf,
      ...
      desc: 'Reuses existing hardware instead of spinning up new data centers. Reduce your carbon footprint.',
      metric: 'Green computing',
    },
  ]
  ...
  return (
    <section className="relative py-28">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <SectionHeader
          badge="Why Willustore"
          title={<>Built for the <span className="gradient-text">Modern Organization</span></>}
          subtitle="Every feature is designed to give you maximum control, minimum cost, and zero compromise on security."
        />
    ...
    <section className="relative py-28 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-10 text-center">
        ...
        <h2 className="font-display font-800 text-4xl md:text-5xl lg:text-6xl mt-6 mb-6 leading-tight">
          Ready to Take Back{' '}
          <span className="gradient-text">Control of Your AI Data?</span>
        </h2>
        ...
        <p className="mt-6 text-text-dim text-sm">
          No credit card required • Free for early adopters • Cancel anytime
        </p>
      </div>
    </section>
  )
