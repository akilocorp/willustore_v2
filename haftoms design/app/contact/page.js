...
const contactReasons = [
  ...
  { value: 'waitlist', label: 'Join Waitlist', icon: User },
  { value: 'university', label: 'University Partnership', icon: GraduationCap },
  { value: 'enterprise', label: 'Enterprise Inquiry', icon: Building2 },
  { value: 'other', label: 'Other', icon: MessageSquare },
]

export default function ContactPage() {
  const [form, setForm] = useState({
    name: '', email: '', org: '', reason: 'demo', message: ''
  })
    ...
    <div className="pt-24">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="absolute inset-0" style={{
          background: 'radial-gradient(ellipse at 30% 30%, rgba(0,212,255,0.06) 0%, transparent 60%)'
        }} />
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {[
                ...
                },
                {
                  ...
                  desc: 'Join 1,000+ builders in our community.',
                },
                {
                  icon: MapPin,
                  title: 'Headquarters',
                  value: 'Addis Ababa, Ethiopia',
                  desc: 'Remote-first, global team.',
                },
            ...
            <div className="lg:col-span-3">
              {submitted ? (
                <div className="glass border-glow rounded-3xl p-16 text-center h-full flex flex-col items-center justify-center">
                  ...
                  <h2 className="font-display font-700 text-3xl text-text-primary mb-4">
                    Message Received!
                  </h2>
                  <p className="text-text-secondary text-lg mb-6 max-w-sm">
                    Thanks for reaching out. Our team will get back to you within 24 hours.
                  </p>
                  <button
                    onClick={() => { setSubmitted(false); setForm({ name: '', email: '', org: '', reason: 'demo', message: '' }) }}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                          ...
                          <button
                            ...
                            className={`px-3 py-2.5 text-xs font-500 rounded-xl border transition-all ${
                              form.reason === value
                                ...
                                : 'glass border-border-subtle text-text-dim hover:border-accent/20 hover:text-text-secondary'
                            }`}
                          >
                            {label}
                          </button>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={form.org}
                        onChange={handleChange}
                        placeholder="University of Addis Ababa"
                        className="w-full bg-navy/60 border border-border-subtle rounded-xl px-4 py-3 text-sm text-text-primary placeholder-text-dim focus:outline-none focus:border-accent/50 focus:bg-accent/5 transition-all"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full flex items-center justify-center gap-3 px-8 py-4 bg-accent text-midnight font-700 rounded-xl hover:bg-accent-glow hover:shadow-lg hover:shadow-accent/25 transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                      {loading ? (
                        <>
