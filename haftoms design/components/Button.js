...
export function Button({ href, onClick, children, variant = 'primary', className = '', size = 'md', ...props }) {
  ...
  const variants = {
    primary: 'bg-accent text-midnight hover:bg-accent-glow hover:shadow-lg hover:shadow-accent/25 hover:-translate-y-0.5 active:translate-y-0',
    ...
    purple: 'bg-accent-warm text-white hover:bg-purple-600 hover:shadow-lg hover:shadow-purple-500/25 hover:-translate-y-0.5',
  }
