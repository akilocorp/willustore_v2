import { Shield, Globe, ArrowRight, Target, Lightbulb, Heart } from 'lucide-react'
...
const values = [
  { icon: Shield, title: 'Privacy First', desc: "We believe organizations should never have to trust a third party with sensitive AI data. Privacy is architecture, not policy." },
  { icon: Globe, title: 'Truly Decentralized', desc: "No central data server. No single point of failure. Distribution is in our DNA — not bolted on as an afterthought." },
  { icon: Lightbulb, title: 'Accessible Innovation', desc: "The most powerful AI storage shouldn't require a Fortune 500 budget. We're making enterprise-grade tech accessible to everyone." },
  { icon: Heart, title: 'Community-Driven', desc: "Users are participants, not just customers. When you share idle storage, you power the network for everyone." },
]
  ...
  return (
    <div className="pt-24">
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at 30% 40%, rgba(110,91,255,0.06) 0%, transparent 60%)' }} />
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
          <div className="max-w-3xl">
            <Badge>Our Story</Badge>
            <h1 className="font-display font-800 text-5xl md:text-6xl leading-tight mt-5 mb-6">
              We're Fixing a <span className="gradient-text">Broken System</span>
            </h1>
            ...
            <Button href="/contact" variant="primary" size="lg">Get In Touch <ArrowRight size={16} /></Button>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <SectionHeader badge="Our Mission" title={<>Decentralize the <span className="gradient-text">AI Data Layer</span></>} subtitle="" center={false} />
              ...
              <p className="text-text-secondary leading-relaxed mb-8">
                We envision a world where universities can train and retrieve AI models using their students' and faculty's devices — turning idle hardware into a powerful private cloud.
              </p>
            ...
            <div className="relative">
              <div className="glass border-glow rounded-3xl p-10 relative overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-accent to-accent-purple flex items-center justify-center text-white font-700 text-sm">AH</div>
                  <div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <SectionHeader badge="Our Values" title={<>What We <span className="gradient-text">Stand For</span></>} subtitle="Every engineering decision, every design choice, every partnership is guided by these core principles." />
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <SectionHeader badge="Our Journey" title={<>From Idea to <span className="gradient-text">Infrastructure</span></>} subtitle="The story of building Willustore from the ground up." />
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center">
          <div className="glass border-glow rounded-3xl p-14 relative overflow-hidden">
            <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at 50% 50%, rgba(110,91,255,0.05) 0%, transparent 70%)' }} />
            <div className="relative">
              <h2 className="font-display font-700 text-4xl text-text-primary mb-4">Join Our <span className="gradient-text">Mission</span></h2>
              <p className="text-text-secondary text-lg mb-8">Whether you're a researcher, developer, or organization leader — we'd love to hear from you.</p>
